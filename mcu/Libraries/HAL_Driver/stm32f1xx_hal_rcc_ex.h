...
#define IS_RCC_USBPLLCLK_DIV(__USBCLK__)                                       \
  ...
  typedef struct
  {
    ...
    uint32_t PLL2MUL; /*!< PLL2MUL: Multiplication factor for PLL2 VCO input
  ...
  typedef struct
  {
    uint32_t PLLI2SMUL; /*!< PLLI2SMUL: Multiplication factor for PLLI2S VCO
                        input clock This parameter must be a value of @ref
...
#define __HAL_RCC_ETH_CLK_DISABLE()                                            \
  ...
  /** @defgroup RCCEx_AHB1_Peripheral_Clock_Enable_Disable_Status AHB1
...
#define __HAL_RCC_TIM14_CLK_DISABLE() (RCC->APB1ENR &= ~(RCC_APB1ENR_TIM14EN))
  ...
  /** @defgroup RCCEx_APB1_Peripheral_Clock_Enable_Disable_Status APB1
   * Peripheral Clock Enable Disable Status
...
#define __HAL_RCC_TIM11_CLK_DISABLE() (RCC->APB2ENR &= ~(RCC_APB2ENR_TIM11EN))
  ...
  /** @defgroup RCCEx_APB2_Peripheral_Clock_Enable_Disable_Status APB2
   * Peripheral Clock Enable Disable Status
